...
import { Service, BookingItem } from '../../types/service';

// Import the JSON data
import hairServicesData from '../../../public/hair_services.json';
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        const transformedServices = hairServicesData.map(transformServiceForComponent);
  ...
  const applyFilters = (services: Service[]) => {
    return services.filter(service => {
      ...
      const typeMatch = serviceType === 'all' ||
        (serviceType === 'cut' && service.category.toLowerCase().includes('cut')) ||
        (serviceType === 'styling' && service.category.toLowerCase().includes('styling')) ||
        (serviceType === 'color' && service.category.toLowerCase().includes('color')) ||
        (serviceType === 'treatment' && service.category.toLowerCase().includes('treatment'));
      // cut, styling,color,treatment
          ...
          <div className="relative max-w-7xl mx-auto">
            ...
            >
              ...
              <p className="text-xl text-pink-100 max-w-2xl mx-auto">
                ...
                Transform your look with our expert Hair Care and Hair Treatment services
              </p>
