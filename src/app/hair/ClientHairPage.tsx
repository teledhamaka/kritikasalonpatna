// app/hair/ClientHairPage.tsx - SEO OPTIMIZED VERSION
"use client";

import { useState, useRef, useCallback, useEffect } from 'react';
import Image from 'next/image';
import dynamic from 'next/dynamic';
import { MapPin, Sparkles, Zap, Phone, Clock, Star, Award, Users, Heart, TrendingUp } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      ...
      <header className="sr-only">
        <h1>Best Hair Salon & Hair Treatment in {seoData.business.address.locality}, Patna | {seoData.business.name}</h1>
        <p>
          Professional hair care services including keratin treatment, hair spa, smoothening treatment, 
          hair coloring, hair fall treatment, and styling in {seoData.business.address.locality}, Patna. 
      ...
      <main className="max-w-7xl mx-auto px-4 py-6 pb-24 md:pb-8">
        ...
        <section className="bg-gradient-to-r from-blue-50 via-purple-50 to-indigo-50 rounded-2xl p-4 mb-6 flex flex-col border border-blue-200">
          <h2 className="sr-only">
            {selectedCategory !== 'All' 
              ? `${selectedCategory} Services in ${seoData.business.address.locality}` 
              : `All Hair Care Services in ${seoData.business.address.locality}, Patna`}
          </h2>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-bold text-gray-900 text-sm sm:text-base">
                  {selectedCategory !== 'All' ? `${selectedCategory} Services` : 'All Hair Services'}
                </h3>
        ...
        <section aria-label="Hair care services list">
          <div
        ...
        <section className="mb-8" aria-label="Browse hair care categories">
          ...
          <nav aria-label="Hair service categories">
                  ...
                  >
                    <div className={`h-full rounded-xl p-2 text-center transition-all duration-300 flex flex-col items-center justify-center ${
                      ...
                      <div className="w-8 h-8 md:w-10 md:h-10 mx-auto mb-1 rounded-full overflow-hidden border border-white/20">
                        <Image 
                          src={getCategoryImage(category|| 'Hair')} 
                          alt={`${category} hair services in ${seoData.business.address.locality}`}
                          width={40}
                          height={40}
        ...
        <section className="mb-8" aria-label="Hair consultation tools">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              className="bg-gradient-to-br from-blue-50 to-purple-100 p-4 rounded-xl hover:shadow-xl transition-all duration-300 flex flex-col items-center text-center border-2 border-blue-200"
              aria-label="Take our hair style quiz"
            >
              <div className="text-3xl mb-2">💇‍♀️</div>
              <h3 className="text-base font-bold text-purple-800">Hair Style Quiz</h3>
              <p className="text-gray-600 text-xs mt-1">Find your perfect hair look!</p>
              <span className="mt-3 bg-white text-blue-600 font-semibold py-1.5 px-3 rounded-full text-xs border border-blue-300">
                Start Quiz
              </span>
            </button>
            <button
              onClick={() => setShowSkinAnalysis(true)}
              className="bg-gradient-to-br from-purple-50 to-blue-100 p-4 rounded-xl hover:shadow-xl transition-all duration-300 flex flex-col items-center text-center border-2 border-purple-200"
              aria-label="Analyze your hair health"
            >
              <div className="text-3xl mb-2">✨</div>
              <h3 className="text-base font-bold text-purple-800">Hair Health Analysis</h3>
              <p className="text-gray-600 text-xs mt-1">Get personalized hair care advice.</p>
        ...
        >
          ...
          <div className="pt-6 border-t border-blue-100">
            <h3 className="font-bold text-gray-900 mb-4 text-center">
              Why Choose {seoData.business.name} for Hair Care?
            </h3>
            <div className="grid grid-cols-3 gap-4">
              <div className="text-center">
                <div className="text-2xl font-bold text-blue-600 mb-1">{allServices.length}+</div>
                <div className="text-xs text-gray-600">Hair Services</div>
              </div>
              ...
              <div className="text-center">
                <div className="text-2xl font-bold text-blue-600 mb-1">2500+</div>
                <div className="text-xs text-gray-600">Hair Clients</div>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="bg-gradient-to-r from-blue-100 via-purple-100 to-indigo-100 rounded-2xl p-4 mb-6 border-2 border-blue-200">
        ...
        {/* Testimonials */}
        <section className="mb-6" aria-label="Customer testimonials for hair services">
        ...
        {/* Promotional Banner */}
        <section className="bg-gradient-to-r from-blue-100 to-purple-100 rounded-xl p-6 text-center border-2 border-blue-200">
          <div className="inline-flex items-center bg-green-500 text-white text-xs font-bold px-2 py-1 rounded-full mb-2">
            <TrendingUp className="mr-1" />
            SPECIAL OFFER
          </div>
          <h3 className="text-lg font-bold text-gray-800">35% OFF On Keratin Treatments</h3>
          <p className="text-gray-600 text-sm mt-1">Transform your hair now and save!</p>
        </section>
      </main>
