// app/makeup/ClientMakeupPage.tsx
"use client";
...
import { ChevronLeft, ChevronRight, Filter, Zap, User, AlertCircle } from 'lucide-react';
...
const ClientMakeupPage = ({ allServices}: ClientMakeupPageProps) => {
  // Core states only
  ...
  const applyFilters = useCallback((services: Service[]) => {
    return services.filter(service => {
      ...
      const typeMatch = serviceTypeFilter === 'all' ||
        (serviceTypeFilter === 'bridal' && service.category?.toLowerCase().includes('bridal')) ||
        (serviceTypeFilter === 'engagement' && service.category?.toLowerCase().includes('engagement')) ||
        (serviceTypeFilter === 'reception' && service.category?.toLowerCase().includes('reception')) ||
        (serviceTypeFilter === 'party' && service.category?.toLowerCase().includes('party'));
    ...
    <div className="min-h-screen bg-linear-to-br from-pink-50 via-white to-purple-50">
      ...
      <div className="bg-linear-to-r from-rose-500 to-pink-600 text-white py-3 px-4 text-center">
        <div className="max-w-7xl mx-auto flex items-center justify-center space-x-2">
          ...
          <span className="text-sm md:text-base">These makeup services are going viral! Book now! 🚀</span>
        </div>
      </div>
      ...
      <main className="max-w-7xl mx-auto py-6 md:py-8 px-4 pb-20 md:pb-8">
        ...
        <MotionSection className="mb-8 md:mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
            ...
            >
              ...
              <h3 className="text-lg md:text-xl font-bold text-purple-800">Makeup Style Quiz</h3>
              <p className="text-gray-600 text-xs md:text-sm mt-1">Find perfect makeup looks tailored for you!</p>
            ...
            >
              <div className="text-3xl md:text-5xl mb-2 md:mb-3">🔍</div>
              <h3 className="text-lg md:text-xl font-bold text-purple-800">Skin Tone Analysis</h3>
              <p className="text-gray-600 text-xs md:text-sm mt-1">Get personalized makeup color advice.</p>
        ...
        <MotionSection className="mb-6 md:mb-8">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-lg md:text-xl font-bold text-gray-800">
              {selectedCategory === 'All' ? 'Select Your Makeup Services' : selectedCategory}
            </h2>
            <button 
          ...
          {showFilters && (
            <div className="bg-white p-4 md:p-6 rounded-xl shadow-md grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 mb-4 md:mb-6 border border-pink-100">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Makeup Service Type</label>
                <select
        ...
        <section className="mb-8 md:hidden">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-lg font-bold text-gray-800">Featured Makeup Services</h2>
        ...
        <section className="hidden md:block mb-8">
          <h2 className="text-xl font-bold text-gray-800 mb-6">
            {selectedCategory === 'All' ? 'All Makeup Services' : selectedCategory} 
          ...
          {filteredAndSortedServices.length === 0 ? (
            <div className="text-center py-12 bg-white rounded-2xl shadow-lg">
              ...
              <h3 className="text-xl font-medium text-gray-600 mb-2">No makeup services found</h3>
        ...
        <section className="bg-linear-to-r from-pink-100 to-purple-100 rounded-xl p-4 md:p-6 mb-6 md:mb-8 text-center border-2 border-pink-200">
          ...
          <h3 className="text-lg md:text-xl font-bold text-gray-800">25% OFF On Bridal Makeup</h3>
          <p className="text-gray-600 text-xs md:text-sm mt-1">Transform, rejuvenate, and save!</p>
        </section>

        {/* Testimonials */}
        <section className="mb-8">
          <h2 className="text-xl md:text-2xl font-bold text-gray-800 mb-4 md:mb-6 text-center">Makeup Transformations & Stories</h2>
          <div className="flex overflow-x-auto space-x-4 md:space-x-6 pb-4 scrollbar-hide">
            <TestimonialCard name="Priya S." text="My bridal makeup was absolutely stunning! The team understood exactly what I wanted!" image="/images/makeup/bridal_makeup.webp" />
            <TestimonialCard name="Ananya R." text="The party makeup lasted all night and got so many compliments! Definitely my go-to salon!" image="/images/makeup/party_makeup.webp" />
            <TestimonialCard name="Maya T." text="The engagement makeup was perfect - natural yet glamorous. The artists are truly talented!" image="/images/makeup/engagement_makeup.webp" />
          </div>
        </section>
      </main>
