...
import { FiChevronLeft, FiChevronRight, FiStar, FiShoppingCart, FiUsers, FiTrendingUp, FiAlertCircle, FiRefreshCw, 
...
import nailServicesData from '../../../public/nail_services.json';
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        const transformedServices = nailServicesData.map(transformServiceForComponent);
  ...
  const applyFilters = (services: Service[]) => {
    return services.filter(service => {
      ...
      const typeMatch = serviceType === 'all' ||
        (serviceType === 'manicure' && service.category.toLowerCase().includes('manicure')) ||
        (serviceType === 'pedicure' && service.category.toLowerCase().includes('pedicure')) ||
        (serviceType === 'nail art' && service.category.toLowerCase().includes('nail art'));
          ...
          <div className="relative max-w-7xl mx-auto">
            ...
            >
              ...
              <p className="text-xl text-pink-100 max-w-2xl mx-auto">
                ...
                Transform your look with our expert Nail Art, Manicure and Pedicure services
              </p>
