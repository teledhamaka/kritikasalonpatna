...
import skinServicesData from '../../../public/skin_services.json';
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        const transformedServices = skinServicesData.map(transformServiceForComponent);
  ...
  const applyFilters = (services: Service[]) => {
    return services.filter(service => {
      ...
      const typeMatch = serviceType === 'all' ||
        (serviceType === 'hair removal' && service.category.toLowerCase().includes('hair removal')) ||
        (serviceType === 'facial treatment' && service.category.toLowerCase().includes('facial treatment')) ||
        (serviceType === 'skin brightening' && service.category.toLowerCase().includes('skin brightening')) ||
        (serviceType === 'skin treatment' && service.category.toLowerCase().includes('skin treatment')) ||
        (serviceType === 'body care' && service.category.toLowerCase().includes('body care'));
          ...
          <div className="relative max-w-7xl mx-auto">
            ...
            >
              ...
              <p className="text-xl text-pink-100 max-w-2xl mx-auto">
                ...
                Transform your look with our expert Skin Care and Body Treatment services
              </p>
